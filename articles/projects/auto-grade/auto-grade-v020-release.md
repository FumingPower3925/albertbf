...
The 100% coverage requirement has been a double-edged sword, but it's also forced us to write testable, modular code. Every new feature comes with its full suite of tests before merging.
